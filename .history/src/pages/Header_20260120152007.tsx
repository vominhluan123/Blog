      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16'>
        ...
        <div className='flex items-center gap-4 relative' ref={searchRef}>
          ...
          {searchResults.length > 0 && (
            <div className='absolute top-full right-0 md:left-auto md:right-0 mt-2 w-full md:w-80 bg-popover border rounded-xl shadow-xl z-50 max-h-96 overflow-y-auto'>
              {isSearching ? (
