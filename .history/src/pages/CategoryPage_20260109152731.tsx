...
const CategoryPage = () => {
  ...
  useTitle(`${category ? category.charAt(0).toUpperCase() + category.slice(1) : 'Danh mục'} • Blog Game`)
  useEffect(() => {
  ...
  if (loading) {
    return (
      <section className='lg:col-span-6'>
        ...
        {/* Skeleton Hero */}
        <div className='mb-10 rounded-2xl bg-linear-to-r from-primary/20 to-primary/10 p-8 overflow-hidden shadow-xl mt-'>
