                  ...
                  <div className='flex items-center justify-between text-sm text-muted-foreground'>
                    <div className='flex items-center gap-3'>
                      <Avatar className='h-8 w-8'>
                        <AvatarImage src={post?.photoURL || 'https://github.com/shadcn.png'} />
                        <AvatarFallback>{post?.displayName?.[0] || 'A'}</AvatarFallback>
                      </Avatar>
                      <span>
                        {post?.displayName} • {post.createdAt.toDate().toLocaleDateString('vi-VN')}
                      </span>
                    </div>
