        ...
        <Card>
          ...
          <CardContent className='space-y-4'>
            <div className='flex flex-col w-full max-w-sm items-start gap-3 mx-auto mb-5'>
              ...
              <Input className={cn(searchInputClass, 'w-full rounded-none')} id='name' placeholder='Nhập tên của bạn' />

              <Label htmlFor='email'>Email</Label>
              <Input
                id='email'
                type='email'
                className={cn(searchInputClass, 'w-full rounded-none')}
                placeholder='email@example.com'
              />

              <Label htmlFor='message'>Tin nhắn</Label>
              <Textarea
                className={cn(searchInputClass, `resize-none w-full rounded-none`)}
                id='message'
