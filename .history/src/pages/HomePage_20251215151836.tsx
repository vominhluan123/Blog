    ...
    <>
      <div className='grid grid-cols-1 lg:grid-cols-12 gap-6'>
        ...
        <section className='lg:col-span-6'>
          {/* Small hero */}
          <div className='mb-6'>
            <div className='rounded-xl overflow-hidden bg-linear-to-r from-indigo-600 to-violet-600 text-white p-6'>
              <div className='max-w-3xl'>
                ...
                <div className='mt-4'>
                  <Button variant='destructive'}>Đọc ngay</Button>
                </div>
              </div>
            </div>
          </div>
              ...
              >
                <div className='flex gap-3'>
                  ...
                  <div className='flex-1'>
                    <h3 id={`post-${post.id}-title`} className='text-lg font-semibold'>
                      {post.title}
                    </h3>
        ...
        <aside className='hidden xl:block xl:col-span-3'>
          <Card className='sticky top-20'>
            <CardContent>
              <h4 className='font-semibold'>Bài viết tuần</h4>
              <ul className='mt-3 space-y-2 text-sm text-slate-700'>
                <li>Top 10 build Jungler mùa 15</li>
                <li>Hướng dẫn map control</li>
                <li>Tin meta mới</li>
              </ul>
              <div className='mt-4'>
                <h4 className='font-semibold'>Tác giả nổi bật</h4>
