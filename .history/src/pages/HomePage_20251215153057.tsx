    ...
    <>
      <div className='grid grid-cols-1 lg:grid-cols-12 gap-6'>
          ...
          <div className='mb-6'>
            <div className='rounded-xl overflow-hidden bg-blue-600 text-white p-6'>
              <div className='max-w-3xl'>
                <h1 className='text-h1 font-extrabold leading-tight'>Bài viết nổi bật</h1>
              ...
              >
                <div className='flex gap-3'>
                  ...
                  <div className='flex-1'>
                    <h3 id={`post-${post.id}-title`} className='text-h3 font-semibold'>
                      {post.title}
                    </h3>
        ...
        <aside className='hidden xl:block xl:col-span-3'>
          <Card className='sticky top-20'>
            <CardContent>
              <h4 className='font-semibold text-h4'>Bài viết tuần</h4>
              ...
              <div className='mt-4'>
                <h4 className='font-semibold text-4'>Tác giả nổi bật</h4>
                <div className='mt-2 flex items-center gap-3'>
                  ...
                  <div>
                    <div className='text-body font-medium'>Author Name</div>
