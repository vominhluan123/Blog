        ...
        <Card>
          ...
          <CardContent className='space-y-4'>
            <div className='flex flex-col w-full max-w-sm items-start gap-3 mx-auto mb-5'>
              ...
              <Input
                className='md:px-4 py-2 rounded-lg md:border bg-card text-foreground placeholder-muted-foreground transition-all duration-300 focus:outline-none focus:ring-2 hidden md:block focus:ring-primary/50 md:w-64 w-0 px-0 border-0'
                id='name'
              ...
              <Textarea className='resize-none' id='message' placeholder='Nội dung bạn muốn hỏi...' />
            </div>
