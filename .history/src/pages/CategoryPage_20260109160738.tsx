                  ...
                  <div className='flex items-center justify-between text-sm text-muted-foreground'>
                    <div className='flex items-center gap-3'>
                      <Avatar className='h-8 w-8'>
                        <AvatarImage src={user.authorPhotoURL || 'https://github.com/shadcn.png'} />
                        <AvatarFallback>{user.authorName?.[0] || 'A'}</AvatarFallback>
                      </Avatar>
                      <span>
                        {user?.displayName} • {post.createdAt.toDate().toLocaleDateString('vi-VN')}
                      </span>
                    </div>
