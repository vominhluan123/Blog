  ...
  useEffect(() => {
    const handleClickOutside = (e: MouseEvent) => {
      if (searchRef.current && !searchRef.current.contains(e.target as Node)) {
        setIsFocused(false)
        setSearchResults([]) // Reset kết quả khi blur hoàn toàn
        // Không reset searchQuery để giữ chữ người dùng gõ (nếu muốn xóa luôn thì thêm setSearchQuery(''))
      }
    }
