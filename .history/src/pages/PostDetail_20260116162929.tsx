    ...
    const fetchRelated = async () => {
      ...
      try {
        ...
        if (post.tags && post.tags.length > 0) {
          ...
          q = query(postsRef, where('tags', 'array-contains-any', tagsToMatch), orderBy('createdAt', 'desc'), limit(6))
        } else {
          // Fallback theo danh mục
          q = query(postsRef, where('category', '==', post.category), orderBy('createdAt', 'desc'), limit(5))
        }
