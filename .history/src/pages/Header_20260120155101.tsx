...
const Header = () => {
  ...
  return (
    ...
    <Search 
      className='absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-foreground/80 pointer-events-none z-10' 
    />
    <Input
    ...
    {/* Dropdown gợi ý */}
    {(searchResults.length > 0 || isSearching || (searchQuery.trim().length > 1 && searchResults.length === 0)) && (
      <div 
