        ...
        <div className='flex items-center gap-4 relative' ref={searchRef}>
          <div className='relative hidden md:block'>
            ...
            <Input
              ...
              onBlur={() => {
                setIsFocused(false)
                setSearchResults([]) // Reset kết quả cũ để lần sau focus lại phải query mới
              }}
              onFocus={() => {
            ...
            {isFocused &&
              (searchResults.length > 0 ||
                ...
                <div
                  ...
                  onMouseDown={(e) => e.stopPropagation()} // Giữ dropdown khi click vào nó
                >
                  {isSearching ? (
                    ...
                    searchResults.map((result) => (
                      <button
                        ...
                        onClick={() => {
                          setSearchQuery('')
                          setSearchResults([])
                          setIsFocused(false) // Ẩn ngay khi click item
