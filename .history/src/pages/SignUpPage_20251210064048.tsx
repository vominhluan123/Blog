...
const SignUpPage = () => {
  ...
  const {
    register,
    handleSubmit,
    formState: { errors, isSubmitting, isDirty, isSubmitted, touchedFields }
  } = useForm<FormData>({
        ...
        <form onSubmit={handleSubmit(handleSignUp)}>
          <div className='flex flex-col w-full max-w-sm items-start gap-3 mx-auto mb-5'>
            ...
            <Input
              ...
              className={`${errors.fullname && touchedFields.fullname ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
              {...register('fullname')}
            />
            ...
            <Input
              ...
              {...register('email')}
              disabled={isSubmitting}
              className={`${errors.email && touchedFields.email ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
            />
