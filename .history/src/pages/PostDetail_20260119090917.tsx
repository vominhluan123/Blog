...
import { LIKE_COLLECTION, POSTS_COLLECTION, type Post } from '@/firebase/db'
import { db } from '@/firebase/firebase-config'
import { useTitle } from '@/hooks/useTitle'
import { collection, doc, getDoc, getDocs, limit, onSnapshot, orderBy, query, runTransaction, where } from 'firebase/firestore'
...
const PostDetail = () => {
  ...
  useEffect(() => {
    ...
    const q = query(
      collection(db, POSTS_COLLECTION, id, 'comments'),
      orderBy('createdAt', 'desc'),
