  ...
  return (
    <div className='min-h-screen p-10'>
      <div className='container w-full mx-auto max-w-5xl p-5 '>
        ...
        <h1 className='text-center text-xl text-primary font-semibold mb-5 bg-blue'>Tạo một tài khoản</h1>
        <form>
          <div className='flex flex-col w-full max-w-sm items-start gap-3 mx-auto mb-5'>
            ...
            <Input type='text' autoFocus id='fullname' placeholder='Luan' className='py-6 px-3.5 text-xs' />
            ...
            <Input type='password' id='password' placeholder='tạo mật khẩu' className='py-6 px-3.5 text-xs' />
