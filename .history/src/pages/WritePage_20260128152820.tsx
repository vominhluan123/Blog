...
// Import và register module List (cho bullet/ordered)

const formats = ['header', 'bold', 'italic', 'underline', 'link', 'list', 'bullet', 'image']
  ...
  const handleImageUpload = () => {
    ...
    input.onchange = async () => {
      ...
      try {
        ...
        toast.error('Upload ảnh thất bại. Thử lại nhé!')
      } finally {
        toast.dismiss()
      }
    }
              ...
              <div className='space-y-2'>
                ...
                <div
                  ...
                  className={cn(
                    ...
                    'dark:bg-background/50 dark:border-primary/20',
                    'dark:focus-within:ring-primary/70 dark:focus-within:shadow-lg dark:focus-within:shadow-primary/30',
                ...
                >
                  <ReactQuill
                    ...
                    value={watch('content') || ''}
                    onChange={(html) => {
                      setValue('content', html, { shouldValidate: false }) // tắt realtime validate
                    }}
                    modules={modules}
                    formats={formats}
                    placeholder='Viết nội dung bài của bạn ở đây...'
                    className='min-h-[400px] text-base quill-shared'
                  />
                </div>
