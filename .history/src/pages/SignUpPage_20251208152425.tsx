      ...
      <div className='container w-full mx-auto max-w-5xl p-5 '>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className='flex flex-col w-full max-w-sm items-start gap-3 mx-auto mb-5'>
            ...
            <Input type='text' autoFocus id='fullname' placeholder='Luan' {...register('fullname')} />
            <Label htmlFor='email' className='font-medium text-sm'>
              Email *
            </Label>
            {errors?.email && <span className='text-red-500 text-sm'>{errors.lastname.message}</span>}
            <Input type='text' id='email' placeholder='123@gmail.com' {...register('email')} />
            <Label htmlFor='password' className='font-medium text-sm'>
              Mật khẩu *
            </Label>
            <PasswordInput id='password' placeholder='tạo mật khẩu' {...register('password')} />
