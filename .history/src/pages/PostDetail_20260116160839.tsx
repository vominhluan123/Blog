      ...
      try {
        ...
        if (post.tags && post.tags.length > 0) {
          ...
          q = query(
            ...
            where('status', '==', PostStatus.APPROVED), // thêm filter nếu cần
        ...
        // Nếu dùng tag → sort theo độ tương đồng tag + thời gian
        if (useTagLogic) {
        ...
        // Nếu dùng category → đã orderBy createdAt rồi, không cần sort thêm
