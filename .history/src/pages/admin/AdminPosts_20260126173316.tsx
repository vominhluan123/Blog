          ...
          <Dialog open={!!selectedPost} onOpenChange={() => setSelectedPost(null)}>
            <DialogContent className='max-w-4xl max-h-[90vh] overflow-y-auto'>
              ...
              <div className='space-y-6 py-4'>
                ...
                {/* Nội dung FULL - CHỐNG BỂ LAYOUT TRIỆT ĐỂ */}
                <div className='prose prose-lg prose-headings:text-foreground prose-strong:text-foreground dark:prose-invert max-w-none leading-relaxed break-words'>
                  {/* Wrapper chính: force break mọi thứ */}
                  <div
                    className='ql-editor prose-p:break-words prose-li:break-words prose-code:break-all prose-pre:overflow-x-auto prose-pre:max-w-full prose-img:max-w-full prose-img:h-auto prose-table:w-full prose-table:overflow-x-auto prose-table:table-auto'
                    style={{
                      wordBreak: 'break-word',
                      overflowWrap: 'break-word',
                      hyphens: 'auto', // tự động ngắt từ tiếng Việt nếu cần
                      whiteSpace: 'normal'
                    }}
                  >
              ...
              <div className='sticky bottom-0 left-0 right-0 bg-background pt-4 border-t mt-8 flex justify-end'>
