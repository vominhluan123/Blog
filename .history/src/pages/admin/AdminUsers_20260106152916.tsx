...
import { AlertTriangle, Eye, Loader2, Shield, Trash2, UserPlus } from 'lucide-react'
...
const AdminUsers = () => {
  ...
  const handleCreateUser = async () => {
    ...
    try {
      ...
      const errorMsg =
        error.code === 'auth/email-already-in-use' ? '❌ Email này đã được sử dụng!' : '❌ Không thể tạo người dùng'
                      ...
                      <Dialog>
                        ...
                        <DialogContent>
                          ...
                          <div className='space-y-4 py-2'>
                            ...
                            <div className='flex justify-end gap-3 pt-4'>
                              <Button variant='outline' onClick={() => setDeletingUserId(null)} disabled={isDeleting}>
                                Hủy
                              </Button>
                              <Button
                                variant='destructive'
