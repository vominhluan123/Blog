...
import { type User as FirebaseUser } from 'firebase/auth' // Để phân biệt với type User của bạn
import { type User, USERS_COLLECTION } from '@/firebase/db' // Type User của bạn
...
const AdminUsers = () => {
  ...
  const roles = ['user', 'moderator', 'admin'] // Có thể thêm role khác nếu cần
