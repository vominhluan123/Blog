...
const AdminPosts = () => {
  ...
  const handleApprove = async (postId: string) => {
    ...
    try {
      ...
      })// Thông báo cho user (tạo notification)
    await addDocc(collection(db, 'notifications'), {
      userId: post.authorId,
      type: 'approved',
      message: `Bài viết "${post.title}" của bạn đã được duyệt và publish!`,
      read: false,
