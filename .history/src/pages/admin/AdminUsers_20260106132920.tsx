...
import { type User, USERS_COLLECTION } from '@/firebase/db' // Giả sử bạn có type User và USERS_COLLECTION
import { auth, db } from '@/firebase/firebase-config' // Thêm auth nếu chưa có
import { collection, getDocs, limit, orderBy, query, startAfter, Timestamp, doc, setDoc } from 'firebase/firestore'
import { createUserWithEmailAndPassword } from 'firebase/auth' // Để tạo user mới
...
import { CheckCircle, Eye, Loader2, Trash, XCircle } from 'lucide-react'
