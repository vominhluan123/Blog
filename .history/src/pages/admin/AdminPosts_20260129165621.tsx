  ...
  const handleDelete = async (postId: string) => {
    try {
      ...
      await updateDoc(doc(db, POSTS_COLLECTION, postId), {
        ...
        deletedBy: 'admin-id-hoac-currentUser.uid', // audit trail
        status: PostStatus.DELETED // nếu bạn muốn thêm status mới
      })

      // Cách 2: Hard delete (nếu chắc chắn không cần giữ)
