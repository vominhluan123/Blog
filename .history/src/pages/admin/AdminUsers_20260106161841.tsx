...
const AdminUsers = () => {
  ...
  const handleCreateUser = async () => {
    ...
    try {
      ...
      // 3. Thêm vào danh sách (thêm lên đầu để hiển thị mới nhất)
      const newUser: User = {
        id: firebaseUser.uid,
        uid: firebaseUser.uid,
        displayName: newDisplayName,
          ...
          <Dialog>
            ...
            <DialogContent className='sm:max-w-md'>
              <DialogHeader>
                ...
                <DialogDescription>Nhập thông tin chi tiết để tạo tài khoản mới trong hệ thống.</DialogDescription>
              </DialogHeader>
              ...
              <div className='space-y-5 py-4'>
                ...
                <div className='flex justify-end gap-3 pt-4'>
                  ...
                  {isLoading ? 'Đang tạo' :<Button onClick={handleCreateUser} disabled={!newEmail || !newPassword}>
                    Tạo ngay
                  </Button>}
                </div>
              </div>
