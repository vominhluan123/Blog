          ...
          <Dialog open={!!selectedPost} onOpenChange={() => setSelectedPost(null)}>
            <DialogContent className='max-w-4xl max-h-[90vh] overflow-y-auto overflow-x-hidden'>
              ...
              <div className='space-y-6 py-4'>
                ...
                <div className='prose prose-lg prose-headings:text-foreground prose-strong:text-foreground dark:prose-invert max-w-none leading-relaxed max-w-none overflow-x-hidden'>
                  <div
                    className='ql-editor quill-shared prose-p:break-words prose-li:break-words prose-code:break-words prose-img:max-w-full prose-img:h-auto prose-table:w-full prose-table:table-auto prose-table:overflow-x-auto'
                    style={{
