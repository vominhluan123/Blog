  ...
  return (
    <div className='min-h-screen p-8 bg-background'>
      <div className='max-w-7xl mx-auto'>
        ...
        {/* Tabs lọc trạng thái */}
        <Tabs value={activeTab} onValueChange={(val) => setActiveTab(val as PostStatus | 'Xoá')} className='mb-8'>
                    ...
                    <div className='flex flex-col items-center justify-center gap-3 text-muted-foreground'>
                      <p className='text-lg'>
                        {searchTerm
                          ...
                          : `Chưa có bài viết ở trạng thái "${activeTab === 'deleted' ? 'Đã xóa' : activeTab}"`}
                      </p>
                      {!searchTerm && (
