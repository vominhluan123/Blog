...
import { collection, getDoc, getDocs, limit, orderBy, query, startAfter, Timestamp, where, writeBatch } from 'firebase/firestore'
...
async function addAuthorSlugToPosts() {
  ...
  for (const postDoc of postsSnap.docs) {
    ...
    if (!post.authorId || post.authorSlug) continue
