  ...
  return (
    <div className='min-h-screen p-8 bg-background'>
      <div className='max-w-6xl mx-auto'>
            ...
            <DialogContent className='max-w-4xl max-h-[90vh] overflow-y-auto'>
              ...
              <div className='space-y-6 py-4'>
                ...
                <div className='prose prose-lg prose-headings:text-foreground prose-strong:text-foreground dark:prose-invert max-w-none leading-relaxed'>
                  <div
                    className='ql-editor' // giữ style Quill gốc (padding, font, heading size...)
        ...
        <div className='flex justify-end gap-4 mt-10 pt-6 border-t sticky bottom-0 bg-background py-4'>
          <Button variant='outline' onClick={() => setSelectedPost(null)}>
            Đóng
          </Button>
          <Button variant='default' onClick={() => handleApprove(selectedPost.id)}>
            Duyệt bài
          </Button>
          <Button variant='destructive' onClick={() => handleReject(selectedPost.id)}>
            Huỷ bài
          </Button>
        </div>
      </div>
