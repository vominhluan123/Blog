              ...
              <TableRow key={post.id}>
                ...
                <TableCell className='flex gap-2'>
                  <Dialog>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        <DialogTitle>Chọn danh mục cho bài viết</DialogTitle>
                      </DialogHeader>
                      <div className='space-y-4'>
                        ...
                        <Button onClick={() => handleApprove(post.id)}>Xác nhận duyệt</Button>
                      </div>
                    </DialogContent>
                  </Dialog>
                  <Dialog>
                    ...
                    <DialogContent className='sm:max-w-md bg-card text-card-foreground'>
                      ...
                      <div className='space-y-4'>
                        ...
                        <Textarea
                          ...
                          className={cn(
                            'min-h-[120px] resize-none', // Giới hạn chiều cao, không cho kéo
                            'border-input bg-background text-foreground placeholder:text-muted-foreground',
                            'focus-visible:ring-primary/50 focus-visible:ring-offset-background',
                            'dark:bg-muted/50 dark:border-primary/20 dark:focus-visible:ring-primary/70'
                          )}
                        />
