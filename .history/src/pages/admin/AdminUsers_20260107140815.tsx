                      ...
                      <TableCell className='text-center'>
                        <Button
                          ...
                          onClick={() => {
                            ...
                            setEditForm(user) // Khởi tạo form edit với dữ liệu hiện tại
                            setIsEditing(false)
                          }}
                        >
          ...
          >
            <DialogContent className='sm:max-w-md'>
              ...
              <DialogFooter className='gap-2! sm:gap-0'>
                {isEditing ? (
                  <>
                    <Button variant='destructive' onClick={() => setIsEditing(false)} disabled={isSaving}>
                      <X className='h-4 w-4' />
                      Hủy
                    </Button>
                  ...
                  <>
                    <Button variant='destructive' onClick={() => setSelectedUser(null)}>
                      Đóng
                    </Button>
