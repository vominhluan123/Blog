              ...
              {isLoading ? (
                [...Array(8)].map((_, i) => (
                  <TableRow key={i}>
                    ...
                    <TableCell><div className='flex gap-1'><Skeleton className='h-5 w-16 rounded-full' /><Skeleton className='h-5 w-20 rounded-full' /></div></TableCell>
                    <TableCell className='text-center'><Skeleton className='h-8 w-8 rounded mx-auto' /></TableCell>
                    <TableCell className='text-right'><div className='flex justify-end gap-2'><Skeleton className='h-9 w-20 rounded-md' /><Skeleton className='h-9 w-16 rounded-md' /></div></TableCell>
                  </TableRow>
                ))
              ) : isSearching ? (
                <TableRow>
