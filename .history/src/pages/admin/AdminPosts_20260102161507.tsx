...
const AdminPosts = () => {
  ...
  useEffect(() => {
    ...
    const results = posts.filter(
      (post) => post.title?.toLowerCase().includes(term) || post.authorName?.toLowerCase().includes(term)
    ...
    <div className='min-h-screen p-8 bg-background'>
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4'>
          <Input placeholder='Tìm theo tiêu đề hoặc tác giả...' className={cn(formInputClass, 'max-w-sm')} value={searchTerm}/>
