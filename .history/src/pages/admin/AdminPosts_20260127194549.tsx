            ...
            <DialogContent className='max-w-4xl max-h-[90vh] overflow-y-auto'>
              ...
              <div className='space-y-6 py-4'>
                ...
                <div className='prose prose-lg prose-headings:text-foreground prose-strong:text-foreground dark:prose-invert max-w-none leading-relaxed wrap-break-word'>
                  <div
                    lang='en'
                    className='ql-editor [&_.ql-editor]:wrap-break-word [&_.ql-editor]:whitespace-pre-wrap prose-p:break-words prose-li:break-words prose-pre:overflow-x-auto prose-pre:max-w-full prose-img:max-w-full prose-img:h-auto prose-table:w-full prose-table:overflow-x-auto prose-table:table-auto quill-shared'
                    style={{
