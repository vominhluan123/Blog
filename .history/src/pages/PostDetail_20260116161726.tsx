  ...
  useEffect(() => {
    ...
    const fetchRelated = async () => {
      ...
      try {
        ...
        let q
        let useTagLogic = false
const snapshot = await getDocs(q)
console.log('Related query type:', useTagLogic ? 'TAG' : 'CATEGORY')
console.log('Query constraints:', q) // ko in được trực tiếp, nhưng có thể log tags/category
console.log('Số docs tìm thấy:', snapshot.size)
console.log('Docs IDs:', snapshot.docs.map(d => d.id))

// Sau khi filter
console.log('Sau filter loại bài hiện tại:', candidates.length)
