          ...
          <CardContent>
            <form onSubmit={handleSubmit(addPost)} className='space-y-8'>
              ...
              <div className='space-y-2'>
                ...
                <div
                  className={cn(
                    // copy style từ formInputClass của bạn, nhưng điều chỉnh cho quill
                    ...
                    // thêm padding cho editor giống textarea
                    'overflow-hidden' // tránh toolbar tràn
                  )}
                >
                  <ReactQuill
                    theme='snow'
                    ...
                    // Tắt các thuộc tính giống Textarea bạn muốn
                    // (ReactQuill không có prop trực tiếp, ta dùng ref hoặc css)
                  />
                </div>
