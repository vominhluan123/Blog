      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16'>
        ...
        <div className='flex items-center gap-4 relative' ref={searchRef}>
          <div className='relative hidden md:block'>
            ...
            {isFocused && (
              <div className='absolute top-full left-0 mt-1.5 w-full bg-popover border rounded-lg shadow-xl z-50 max-h-80 overflow-y-auto'>
                {isSearching ? (
                  ...
                  searchResults.map((result) => (
                    <Button
                      ...
                      onClick={(e) => {
                        ...
                        e.stopPropagation() // Ngăn lan lên document
                        console.log('Click:', result.id) // Debug
                      ...
                      className='w-full justify-start px-4 py-3 text-sm hover:bg-accent/80 transition-colors flex items-center gap-3 border-b last:border-b-0 h-auto'
                    >
                  ...
                  <div className='p-4 text-center text-sm text-muted-foreground'>Không tìm thấy bài viết</div>
                ) : (
                  <div className='p-4 text-center text-sm text-muted-foreground'>Gõ ít nhất 2 ký tự để tìm...</div>
                )}
              </div>
            )}
          </div>
