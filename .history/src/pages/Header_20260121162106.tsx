                  ...
                  <div className='max-h-[280px] overflow-y-auto'>
                    {searchResults.map((result) => (
                      <Button
                        key={result.id}
                        variant='ghost'
                        className='w-full h-auto justify-start px-4 py-2.5 text-sm hover:bg-accent/70 transition-colors flex items-center gap-3 rounded-none text-muted-foreground'
                        onClick={(e) => {
                          e.preventDefault()
                          e.stopPropagation()
