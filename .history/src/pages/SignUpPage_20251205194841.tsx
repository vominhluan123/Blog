      ...
      <div className='container w-full mx-auto max-w-5xl p-5 '>
        ...
        <form>
          <div className='flex flex-col w-full max-w-sm items-start gap-3'>
            <label htmlFor='fullname' className='font-medium text-sm text-primary'>
              Full Name *
            </label>
            <Input type='text' id='fullname' placeholder='Luan' className='py-6 px-3.5 placeholder:text-blue-500' />
          </div>
        </form>
      </div>
    </div>
