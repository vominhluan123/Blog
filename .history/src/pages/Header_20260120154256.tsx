        ...
        <div className='flex items-center gap-4 relative' ref={searchRef}>
          <div className='flex items-center gap-4' ref={searchRef}>
            <div className='relative hidden md:block'>
              <Search className='absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-primary/80 pointer-events-none' />
              <Input
              ...
              {(searchResults.length > 0 ||
                ...
                <div className='absolute top-full left-0 mt-1 w-full bg-popover border rounded-md shadow-lg z-50 max-h-80 overflow-y-auto divide-y divide-border'>
                  {isSearching ? (
                    // Loading skeleton
