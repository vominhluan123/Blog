    ...
    try {
      ...
      if (error.code === 'auth/email-already-in-use') {
        toast({
          ...
          description: 'Vui lòng dùng email khác để đăng ký.',
          variant: 'destructive'
        })
        return
      }
      ...
      if (error.code === 'auth/invalid-email') {
        toast({
          ...
          description: 'Hãy kiểm tra lại địa chỉ email.',
          variant: 'destructive'
        })
        return
      }
      ...
      <div className='container w-full mx-auto max-w-5xl p-5 '>
        ...
        <form onSubmit={handleSubmit(handleSignUp)}>
          <div className='flex flex-col w-full max-w-sm items-start gap-3 mx-auto mb-5'>
            ...
            <Button size='lg' className='w-full py-6 px-3.5 cursor-pointer' type='submit'>
