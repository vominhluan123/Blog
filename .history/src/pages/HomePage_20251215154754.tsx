            ...
            <CardContent>
              ...
              <div className='mt-4'>
                ...
                <div className='mt-2 space-y-2 text-sm text-slate-600'>
                  <Link className='hover:text-slate-900'>Game</Link>
                  <Link className='hover:text-slate-900'>Esports</Link>
                  <Link className='hover:text-slate-900'>Review</Link>
                  <Link className='hover:text-slate-900'>Tips</Link>
                </div>
              </div>
            </CardContent>
          </Card>
