    ...
    <section className='lg:col-span-6'>
        ...
        <div className='mb-12 rounded-3xl bg-linear-to-br from-primary to-primary/80 p-8 md:p-12 lg:p-10 shadow-2xl border border-primary/30 relative'>
          ...
          <div className='relative z-10 max-w-4xl mx-auto'>
            ...
            <PostContentPreview
              ...
              className='text-lg md:text-xl text-white/90 mb-8 line-clamp-4'
              maxLength={200}
            />
      ...
      <div className='space-y-6'>
        {posts.map((post) => (
          <article
            key={post.id}
            className='rounded-xl border bg-card p-6 shadow-sm hover:shadow-md tran sition-all ov duration-300'
          >
            <div className='flex flex-col md:flex-row gap-6'>
              {post.image && (
