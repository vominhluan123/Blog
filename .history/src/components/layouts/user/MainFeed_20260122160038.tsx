...
const MainFeed = () => {
  ...
  return (
    <section className='lg:col-span-6'>
      ...
      {featuredPost ? (
        <div className='mb-12 rounded-3xl bg-gradient-to-br from-primary to-primary/80 p-8 md:p-12 lg:p-16 shadow-2xl border-4 border-primary/30 relative overflow-hidden'>
