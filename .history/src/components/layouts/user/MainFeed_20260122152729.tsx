...
const MainFeed = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Chỉ trigger khi cuộn gần bottom (cách bottom < 300px)
    ...
    // Trigger kiểm tra ngay lần đầu (nếu trang đã ngắn, có thể load thêm)
    handleScroll() // gọi 1 lần để check initial

    return () => window.removeEventListener('scroll', handleScroll)
  }, [lastDoc, loading, loadingMore, hasMore])
