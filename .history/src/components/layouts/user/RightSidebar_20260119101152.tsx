...
import { Link } from 'react-router-dom' // sửa thành react-router-dom nếu dùng v6
...
const RightSidebar = () => {
  const [hotPosts, setHotPosts] = useState<Post[]>([]) // gộp chung 1 list hot
    ...
    const fetchData = async () => {
      try {
        ...
        const qAll = query(
          ...
          limit(100) // tăng nếu bạn nghĩ tuần có nhiều bài hơn
        )
