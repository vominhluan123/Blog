    ...
    <section className='lg:col-span-6'>
        ...
        <div className='mb-12 rounded-3xl bg-linear-to-br from-primary to-primary/80 p-8 md:p-12 lg:p-10 shadow-2xl border border-primary/30 relative'>
          ...
          <div className='relative z-10 max-w-4xl mx-auto'>
            ...
            <PostContentPreview
              ...
              maxLength={300}
              className='text-lg md:text-xl text-white/90 mb-8 line-clamp-4 leading-relaxed'
            />
            <div className='flex flex-col sm:flex-row sm:items-center gap-6'>
              ...
              <div className='flex items-center gap-4 text-white/90'>
                ...
                <div className='text-base'>
                  <Link to=`/author/${createSlug(featuredPost.authorName)}` className='font-medium'>{featuredPost.authorName}</Link>
      ...
      <div className='space-y-6'>
        {posts.map((post) => (
          <article
            key={post.id}
            className='rounded-xl border bg-card p-6 shadow-sm hover:shadow-md tran sition-all duration-300'
          >
            <div className='flex flex-col md:flex-row gap-6'>
              {post.image && (
              ...
              <div className='flex-1'>
                ...
                <div className='flex items-center justify-between text-sm text-muted-foreground'>
                  <Link to={`/author/${createSlug(post.authorName)}`} className='flex items-center gap-3 group'>
                  ...
                  <div className='flex gap-4'>
                    ...
                    <button className='hover:text-primary transition-colors'>Comment ({post.commentsCount})</button>
                  </div>
                </div>
              </div>
            </div>
