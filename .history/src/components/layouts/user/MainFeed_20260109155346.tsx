...
import { PostStatus, type Post } from '@/firebase/db' // Import interface Post của bạn
...
const MainFeed = () => {
  ...
  console.log('🚀 ~ MainFeed ~ posts:', posts)
            ...
            <div className='mt-6 flex items-center gap-4'>
              ...
              <div className='text-sm opacity-80 flex items-center gap-2'>
                <Avatar className='h-8 w-8'>
                  <AvatarImage src={featuredPost.photo || 'https://github.com/shadcn.png'} />
