...
import type { slugToCategoryName } from '@/firebase/db'
import { cn } from '@/lib/utils' // ← shadcn helper classnames
import { Gamepad2, Lightbulb, Star, Trophy } from 'lucide-react'
import { Link, useLocation } from 'react-router'

const categories = [
  { slug: 'game', to: '/categories/game', label: 'Hướng dẫn chơi game', icon: Gamepad2 },
  {
    id: 'esports',
...
const LeftSidebar = () => {
  ...
  const currentCategory = location.pathname.split('/').at(-1) || ''
