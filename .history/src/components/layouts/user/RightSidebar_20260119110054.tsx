  ...
  return (
    <aside className='hidden xl:block xl:col-span-3'>
      <div className='sticky top-24 space-y-6'>
            ...
            {loading ? (
              ...
              <ol className='space-y-4'>
                {hotPosts.map((post, index) => (
                  <li key={post.id}>
                    <Link
                      tto={`/author/${author.authorSlug || createSlug(author.authorName)}`}transition-all duration-200 rounded-lg p-2 -mx-2'
                    >
                      <div
        ...
        {/* Tác giả nổi bật - giữ nguyên nhưng thêm chút polish */}
        <Card className='rounded-2xl border bg-card/80 backdrop-blur-sm shadow-md overflow-hidden'>
          <CardContent className='p-6'>
