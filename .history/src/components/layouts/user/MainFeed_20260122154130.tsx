  ...
  return (
    <section className='lg:col-span-6'>
      ...
      {featuredPost ? (
          ...
          <div className='absolute inset-0'>
            {featuredPost.image ? (
              <img
                ...
                className='h-full w-full object-cover brightness-75' // brightness để text rõ hơn
              />
            ) : (
              <div className='h-full w-full bg-gradient-to-br from-primary via-primary/80 to-primary/50' />
            )}
        ...
        <div className='mb-12 rounded-3xl bg-gradient-to-r from-muted/80 to-muted p-12 text-center shadow-xl'>
