...
const MainFeed = () => {
  return (
    <section className='lg:col-span-6'>
      ...
      {/* Hero */}
      <div className='mb-10 rounded-2xl bg-primary p-8 text-primary-foreground overflow-hidden'>
        <div className='max-w-3xl'>
          <h2 className='text-h2 font-extrabold leading-tight'></h2>
          <p className='mt-4 text-primary-foreground/90 text-body'>{featuredPost.excerpt}</p>
