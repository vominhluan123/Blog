...
const MainFeed = () => {
  ...
  return (
    <section className='lg:col-span-6'>
      ...
      {featuredPost ? (
        <div className='mb-10 rounded-2xl bg-gradient-to-r from-primary to-primary/80 p-8 text-primary-foreground overflow-hidden shadow-xl'>
            ...
            <div className='mt-6 flex items-center gap-4'>
              ...
              <div className='text-sm opacity-80 flex items-center gap-2'>
                <Avatar className='h-8 w-8'>
                  <AvatarImage src={featuredPost.a || 'https://github.com/shadcn.png'} />
