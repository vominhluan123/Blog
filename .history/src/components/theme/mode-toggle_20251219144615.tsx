import { Gamepad2, Moon, Sparkles, Sun, Zap } from 'lucide-react'
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant='outline' size='icon'>
          ...
          <Gamepad2 className='absolute h-5 w-5 rotate-180 scale-0 transition-all dark:rotate-0 dark:scale-100 text-purple-400' />
